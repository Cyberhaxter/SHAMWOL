...
module.exports = {
    VERSION: 'v1.1.4',
    SESSION: process.env.SHAMWOL_SESSION === undefined ? '' : process.env.SHAMWOL_SESSION,
    ...
    STICKER_PACKNAME: process.env.STICKER_PACKNAME === undefined ? '🥰,SHAMWOL' : process.env.STICKER_PACKNAME,
